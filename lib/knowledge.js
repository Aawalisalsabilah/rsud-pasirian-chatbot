...
// ===== AMBIL JADWAL DOKTER DARI SUPABASE (bukan hardcoded lagi) =====
// Hanya ambil jadwal yang is_active = true, jadi jadwal yang lagi "Libur"
// otomatis ga ikut dijawab ke pasien lewat chatbot.
...
// ===== AMBIL baseInfo (SELALU DI-INCLUDE, TANPA SIMILARITY SEARCH) =====
...
// ===== FUNGSI UTAMA (dipanggil dari route.js, signature SAMA seperti sebelumnya) =====
export async function buildSystemPrompt(userQuestion = '') {
  ...
  // 1. Base info RS -- selalu di-include, bukan hasil pencarian
  ...
  // 3. Jadwal dokter -- tetep pakai keyword-detection (karena ini data terstruktur,
  //    similarity search kurang cocok buat nama-nama dokter/poli spesifik)
